      ...
      <div class="citruss-tabs-container">
        ...
        <div style="padding-top: 20px;">
          ...
          <div class="citruss-tab-pane active" id="tab-general">
            <h4 style="color: var(--citruss-text-main); margin: 0 0 10px; font-weight: 700;">Genel Sunucu Yapılandırması</h4>
          ...
          <div class="citruss-tab-pane" id="tab-security">
            <h4 style="color: var(--citruss-text-main); margin: 0 0 10px; font-weight: 700;">Güvenlik & Yetkilendirme</h4>
            <p style="color: var(--citruss-text-muted); font-size: 0.92rem; line-height: 1.6; margin: 0;">
          ...
          <div class="citruss-tab-pane" id="tab-logs">
            <h4 style="color: var(--citruss-text-main); margin: 0 0 10px; font-weight: 700;">Sistem Çalışma Günlükleri</h4>
            <p style="color: var(--citruss-text-muted); font-size: 0.92rem; line-height: 1.6; margin: 0;">
