            ...
            <tr>
              <td>
                <div style="display: flex; align-items: center; gap: 10px;">
                  ...
                  <span style="font-weight: 600; color: #fff;">Defne Trunçgil</span>
                </div>
              </td>
              <td>🇹🇷 TR-Istanbul</td>
              <td>4.2 GB/s</td>
            ...
            <tr>
              <td>
                <div style="display: flex; align-items: center; gap: 10px;">
                  ...
                  <span style="font-weight: 600; color: #fff;">Yiğit Trunçgil</span>
                </div>
              </td>
              <td>🇩🇪 DE-Frankfurt</td>
              <td>3.8 GB/s</td>
            ...
            <tr>
              <td>
                <div style="display: flex; align-items: center; gap: 10px;">
                  ...
                  <span style="font-weight: 600; color: #fff;">Okan Trunçgil</span>
                </div>
              </td>
              <td>🇬🇧 UK-London</td>
              <td>0.0 GB/s</td>
