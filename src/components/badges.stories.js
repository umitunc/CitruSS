  ...
  return `
    <div style="padding: 30px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 20px;">
        <!-- Renk/Tema Çeşitleri -->
        <div>
          <h4 style="color: #a3a9b6; font-size: 0.9rem; margin-bottom: 12px;">Tema Çeşitleri (Badge Themes):</h4>
        ...
        <div>
          <h4 style="color: #a3a9b6; font-size: 0.9rem; margin-bottom: 12px;">Metinlerle Birlikte Kullanım (Inline Badges):</h4>
          <div style="display: flex; flex-direction: column; gap: 12px;">
            <h2 style="color: #ffffff; font-family: 'Outfit', sans-serif; margin: 0; font-size: 1.8rem; display: flex; align-items: center; gap: 10px;">
              Admin Kontrol Paneli <span class="citruss-badge badge-primary" style="font-size: 0.8rem; vertical-align: middle;">PRO</span>
            </h2>
            <p style="color: #a3a9b6; margin: 0;">
