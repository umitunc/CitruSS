  ...
  return `
    <div style="padding: 30px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 24px;">
        <!-- Dinamik Alan -->
        <div>
          <h4 style="color: var(--citruss-text-muted); font-size: 0.9rem; margin-bottom: 12px;">Dinamik Kontrollerle Değişen Avatar:</h4>
        ...
        <!-- Boyut Çeşitleri -->
        <div>
          <h4 style="color: var(--citruss-text-muted); font-size: 0.9rem; margin-bottom: 12px;">Boyut Çeşitleri (Avatar Sizes):</h4>
        ...
        <!-- Durum Göstergeleri -->
        <div>
          <h4 style="color: var(--citruss-text-muted); font-size: 0.9rem; margin-bottom: 12px;">Durum Göstergeleri (Presence Indicators):</h4>
