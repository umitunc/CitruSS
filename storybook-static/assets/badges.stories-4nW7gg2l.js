const i={title:"Data Display/Badges"},t=`
...
`.trim(),s=()=>`
  ...
  `;s.parameters={docs:{source:{code:t}}};var e,a,r;s.parameters={...s.parameters,docs:{...(e=s.parameters)==null?void 0:e.docs,source:{originalSource:`() => {
  return \`
    <div style="padding: 30px;">
      <h3 style="color: var(--citruss-text-main); font-family: 'Outfit', sans-serif; font-weight: 800; margin-bottom: 20px; font-size: 1.5rem;">
        Badges
  ...
  \`;
}`,...(r=(a=s.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};const n=["BadgeShowcase"];export{s as BadgeShowcase,n as __namedExportsOrder,i as default};
