const{useEffect:t}=__STORYBOOK_MODULE_PREVIEW_API__,c={title:"Interactive/Accordion"},e=`
...
`.trim(),r=()=>(t(()=>{var i;const o=document.getElementById("accordion-group-demo");o&&((i=window.CitruSS)!=null&&i.Accordion)&&new window.CitruSS.Accordion(o)},[]),`
    <div style="padding: 30px; max-width: 650px;">
      ...
      <details class="citruss-code-wrapper" style="margin-top: 32px; border: 1px solid var(--citruss-glass-border); border-radius: 12px; background: rgba(0,0,0,0.2); overflow: hidden; font-family: 'Outfit', sans-serif;">
        ...
        <div style="padding: 16px; border-top: 1px solid var(--citruss-glass-border); background: var(--citruss-bg-surface); overflow-x: auto;">
          <pre style="margin: 0; white-space: pre-wrap;"><code style="font-family: monospace; color: var(--citruss-text-main); font-size: 0.85rem; line-height: 1.5;">${e.replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
        </div>
      </details>
    </div>
  `);r.parameters={docs:{source:{code:e}}};var s,a,n;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`() => {
  useEffect(() => {
  ...
  \`;
}`,...(n=(a=r.parameters)==null?void 0:a.docs)==null?void 0:n.source}}};const d=["StandardAccordion"];export{r as StandardAccordion,d as __namedExportsOrder,c as default};
