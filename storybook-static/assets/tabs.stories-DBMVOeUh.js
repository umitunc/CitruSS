const{useEffect:c}=__STORYBOOK_MODULE_PREVIEW_API__,l={title:"Interactive/Tabs"},n=`
...
`.trim(),t=()=>(c(()=>{var a;const e=document.getElementById("demo-tabs-nav");e&&((a=window.CitruSS)!=null&&a.Tabs)&&new window.CitruSS.Tabs(e)},[]),`
  ...
  `);t.parameters={docs:{source:{code:`${n}

/* Javascript */
${o}`}}};var s,r,i;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`() => {
  useEffect(() => {
    const tabsWrapper = document.getElementById('demo-tabs-nav');
    if (tabsWrapper && window.CitruSS?.Tabs) {
      new window.CitruSS.Tabs(tabsWrapper);
  ...
  \`;
}`,...(i=(r=t.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const d=["TabSwitching"];export{t as TabSwitching,d as __namedExportsOrder,l as default};
