const{useEffect:o}=__STORYBOOK_MODULE_PREVIEW_API__,d={title:"Interactive/Wizard (Multi-Step Form)"},n=`
...
`.trim(),t=()=>(o(()=>{var s;(s=window.CitruSS)!=null&&s.Wizard&&new window.CitruSS.Wizard("demo-wizard-standalone")},[]),`
...
/* Javascript */
${a}`}}};var e,i,r;t.parameters={...t.parameters,docs:{...(e=t.parameters)==null?void 0:e.docs,source:{originalSource:`() => {
  useEffect(() => {
    if (window.CitruSS?.Wizard) {
      new window.CitruSS.Wizard('demo-wizard-standalone');
    }
  ...
  \`;
}`,...(r=(i=t.parameters)==null?void 0:i.docs)==null?void 0:r.source}}};const l=["WizardShowcase"];export{t as WizardShowcase,l as __namedExportsOrder,d as default};
