const l={title:"Core/Backgrounds"},c=`
...
`.trim(),t=()=>`
    <div style="padding: 40px; max-width: 1100px; margin: 0 auto; font-family: var(--citruss-font-body);">
      ...
      <details class="citruss-code-wrapper" style="margin-top: 32px; border: 1px solid var(--citruss-glass-border); border-radius: 12px; background: rgba(0,0,0,0.2); overflow: hidden;">
        ...
        <div style="padding: 16px; border-top: 1px solid var(--citruss-glass-border); background: var(--citruss-bg-surface); overflow-x: auto;">
          <pre style="margin: 0; white-space: pre-wrap;"><code style="font-family: monospace; color: var(--citruss-text-main); font-size: 0.85rem; line-height: 1.5;">${c.replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
        </div>
      </details>
    </div>
  `,s=()=>`
  ...
  `;t.parameters={docs:{source:{code:c}}};var i,e,r;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return \`
    <div style="padding: 40px; max-width: 1100px; margin: 0 auto; font-family: var(--citruss-font-body);">
      <div style="margin-bottom: 40px;">
        <h1 style="color: var(--citruss-text-main); font-family: var(--citruss-font-display); font-weight: 800; font-size: 2.2rem; margin-bottom: 12px;">
  ...
  \`;
}`,...(r=(e=t.parameters)==null?void 0:e.docs)==null?void 0:r.source}}};var n,a,o;s.parameters={...s.parameters,docs:{...(n=s.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  return \`
    <div style="padding: 40px; max-width: 1100px; margin: 0 auto; font-family: var(--citruss-font-body);">
      <div style="margin-bottom: 40px;">
        <h1 style="color: var(--citruss-text-main); font-family: var(--citruss-font-display); font-weight: 800; font-size: 2.2rem; margin-bottom: 12px;">
  ...
  \`;
}`,...(o=(a=s.parameters)==null?void 0:a.docs)==null?void 0:o.source}}};const d=["DynamicOrbs","PureCSSMeshGradients"];export{t as DynamicOrbs,s as PureCSSMeshGradients,d as __namedExportsOrder,l as default};
