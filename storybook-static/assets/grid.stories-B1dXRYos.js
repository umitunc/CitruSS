const d={title:"Layout/Grid & Responsive"},r=`
...
`.trim(),e=()=>`
    <div style="padding: 40px; font-family: 'Outfit', sans-serif; max-width: 1200px; margin: 0 auto;">
      ...
      <section style="margin-bottom: 20px;">
        ...
        <details class="citruss-code-wrapper" style="margin-top: 24px; border: 1px solid var(--citruss-glass-border); border-radius: 12px; background: rgba(0,0,0,0.2); overflow: hidden;">
          ...
          <div style="padding: 16px; border-top: 1px solid var(--citruss-glass-border); background: var(--citruss-bg-surface); overflow-x: auto;">
            <pre style="margin: 0; white-space: pre-wrap;"><code style="font-family: monospace; color: var(--citruss-text-main); font-size: 0.85rem; line-height: 1.5;">${i.replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
          </div>
        </details>
      </section>
    </div>
  `;e.storyName="Grid & Responsive Showcase";var o,a,n;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`() => {
  return \`
    <div style="padding: 40px; font-family: 'Outfit', sans-serif; max-width: 1200px; margin: 0 auto;">
      <div style="margin-bottom: 32px;">
        <span style="font-size: 0.85rem; font-weight: 700; color: var(--citruss-orange); letter-spacing: 2px; text-transform: uppercase;">Core Layout System</span>
  ...
  \`;
}`,...(n=(a=e.parameters)==null?void 0:a.docs)==null?void 0:n.source}}};const l=["ResponsiveGridSystem"];export{e as ResponsiveGridSystem,l as __namedExportsOrder,d as default};
