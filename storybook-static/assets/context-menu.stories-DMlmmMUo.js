const{useEffect:a}=__STORYBOOK_MODULE_PREVIEW_API__,c={title:"Interactive/Context Menu"},o=`
<!-- Trigger Element -->
...
`.trim(),e=()=>(a(()=>{var n;(n=window.CitruSS)!=null&&n.ContextMenu&&window.CitruSS.ContextMenu.bind("#context-menu-trigger-zone","demo-context-menu")},[]),`
  ...
  `);e.parameters={docs:{source:{code:`${o}

/* Javascript */
${s}`}}};var t,r,i;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`() => {
  useEffect(() => {
    if (window.CitruSS?.ContextMenu) {
      window.CitruSS.ContextMenu.bind('#context-menu-trigger-zone', 'demo-context-menu');
    }
  ...
  \`;
}`,...(i=(r=e.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const d=["StandardContextMenu"];export{e as StandardContextMenu,d as __namedExportsOrder,c as default};
