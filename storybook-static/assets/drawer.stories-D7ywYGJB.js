const{useEffect:n}=__STORYBOOK_MODULE_PREVIEW_API__,d={title:"Interactive/Drawer"},a=`
<!-- Trigger Button -->
...
`.trim(),e=()=>(n(()=>{var r;(r=window.CitruSS)!=null&&r.Drawers&&window.CitruSS.Drawers.init()},[]),`
...
/* Javascript */
${o}`}}};var t,s,i;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`() => {
  useEffect(() => {
    if (window.CitruSS?.Drawers) {
      window.CitruSS.Drawers.init();
    }
  ...
  \`;
}`,...(i=(s=e.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};const l=["StandardDrawer"];export{e as StandardDrawer,l as __namedExportsOrder,d as default};
