const l={title:"Data Display/Timeline"},n=`
<!-- Standard Timeline -->
...
`.trim(),e=()=>`
    <div style="padding: 30px; max-width: 500px;">
      ...
      <details class="citruss-code-wrapper" style="border: 1px solid var(--citruss-glass-border); border-radius: 12px; background: rgba(0,0,0,0.2); overflow: hidden; font-family: 'Outfit', sans-serif;">
        ...
        <div style="padding: 16px; border-top: 1px solid var(--citruss-glass-border); background: var(--citruss-bg-surface); overflow-x: auto;">
          <pre style="margin: 0; white-space: pre-wrap;"><code style="font-family: monospace; color: var(--citruss-text-main); font-size: 0.85rem; line-height: 1.5;">${n.replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
        </div>
      </details>
    </div>
  `;e.parameters={docs:{source:{code:n}}};var i,s,t;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return \`
    <div style="padding: 30px; max-width: 500px;">
      <h3 style="color: var(--citruss-text-main); font-family: 'Outfit', sans-serif; font-weight: 800; margin-bottom: 20px; font-size: 1.5rem;">
        Timeline
  ...
  \`;
}`,...(t=(s=e.parameters)==null?void 0:s.docs)==null?void 0:t.source}}};const a=["TimelineShowcase"];export{e as TimelineShowcase,a as __namedExportsOrder,l as default};
