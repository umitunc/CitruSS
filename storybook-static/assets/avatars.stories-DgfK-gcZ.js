const c={title:"Data Display/Avatars",argTypes:{shape:{control:"select",options:["circle","rounded","square"]},status:{control:"select",options:["none","online","offline"]}}},o=`
...
`.trim(),a=({shape:t="circle",status:s="online"})=>{const n=t==="square"?"border-radius: 0px;":t==="rounded"?"border-radius: 8px;":"";return`
    <div style="padding: 30px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 24px;">
        ...
        <div>
          ...
          <div class="citruss-avatar ${s!=="none"?`status-${s}`:""}" style="${n} width: 64px; height: 64px;">
            <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80" alt="Avatar">
          </div>
        </div>
  ...
  `};a.parameters={docs:{source:{code:o}}};var r,e,i;a.parameters={...a.parameters,docs:{...(r=a.parameters)==null?void 0:r.docs,source:{originalSource:`({
  shape = 'circle',
  status = 'online'
}) => {
  ...
  \`;
}`,...(i=(e=a.parameters)==null?void 0:e.docs)==null?void 0:i.source}}};const d=["AvatarShowcase"];export{a as AvatarShowcase,d as __namedExportsOrder,c as default};
