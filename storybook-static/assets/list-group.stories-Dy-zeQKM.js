const o={title:"Data Display/List Group"},e=`
<!-- Standard List Group -->
...
`.trim(),s=()=>`
  ...
  `;s.parameters={docs:{source:{code:e}}};var r,t,i;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  return \`
    <div style="padding: 30px; max-width: 450px;">
      <h3 style="color: var(--citruss-text-main); font-family: 'Outfit', sans-serif; font-weight: 800; margin-bottom: 20px; font-size: 1.5rem;">
        List Group
  ...
  \`;
}`,...(i=(t=s.parameters)==null?void 0:t.docs)==null?void 0:i.source}}};const a=["ListGroupShowcase"];export{s as ListGroupShowcase,a as __namedExportsOrder,o as default};
