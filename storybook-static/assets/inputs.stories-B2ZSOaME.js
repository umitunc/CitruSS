const{useEffect:c}=__STORYBOOK_MODULE_PREVIEW_API__,d={title:"Forms/Inputs & Form Controls"},t={mail:'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: block;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: block;"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>',search:'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: block;"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',upload:'<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: block; margin: 0 auto;"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>'},i=()=>(c(()=>{var l;const s=document.querySelector(".citruss-upload-zone");s&&(s.addEventListener("dragover",e=>{e.preventDefault(),s.classList.add("dragover")}),s.addEventListener("dragleave",()=>{s.classList.remove("dragover")}),s.addEventListener("drop",e=>{e.preventDefault(),s.classList.remove("dragover")})),(l=window.CitruSS)!=null&&l.Validator&&window.CitruSS.Validator.bind("#demo-validation-form",e=>{var a;(a=window.CitruSS)!=null&&a.toast?window.CitruSS.toast({title:"Form Validated!",message:"Your registration data complies with all requirements.",type:"success"}):alert("Success! Form details are valid.")})},[]),`
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
              ...
              <div class="citruss-form-group">
                ...
                <div class="citruss-input-icon-wrapper icon-left">
                  ...
                  <div class="citruss-icon">${t.search}</div>
                </div>
              </div>
              ...
              <div class="citruss-form-group">
                ...
                <div class="citruss-input-icon-wrapper icon-right">
                  ...
                  <div class="citruss-icon">${t.mail}</div>
                </div>
              </div>
          ...
          <div style="background: rgb(255 255 255 / 1%); border: 1px solid var(--citruss-glass-border); padding: 24px; border-radius: 12px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
              ...
              <div class="citruss-upload-zone">
                <div class="upload-icon">${t.upload}</div>
              ...
              <div class="citruss-validation-group">
                <div class="citruss-form-group" style="margin-bottom: 0;">
                  ...
                  <div class="citruss-input-icon-wrapper icon-left">
                    ...
                    <div class="citruss-icon">${t.lock}</div>
                  </div>
                </div>
              </div>
...
&lt;/div&gt;</code></pre>
  ...
  `);i.parameters={docs:{source:{code:`<!-- CitruSS Form Inputs Showcase -->
<div class="citruss-form-group">
  <label class="citruss-form-label">Full Name</label>
  <input type="text" class="citruss-input" placeholder="e.g. Jane Doe" />
</div>
...
<div class="citruss-validation-group">
  <input type="email" class="citruss-input" required data-citruss-rules="email" />
</div>`}}};var r,n,o;i.parameters={...i.parameters,docs:{...(r=i.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  useEffect(() => {
...
&lt;/div&gt;</code></pre>
  ...
  \`;
}`,...(o=(n=i.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};const p=["CompleteFormGallery"];export{i as CompleteFormGallery,p as __namedExportsOrder,d as default};
